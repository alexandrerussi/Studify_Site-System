...
public partial class login : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        txtSenhaLogin.Attributes["type"] = "password";
    ...
    protected void btnLoginPage_Click(object sender, EventArgs e)
    {
        ...
        string strSQLBuscaLogin = "SELECT Id_Professor, Nome_Professor, Email_Professor,Senha_Professor,Categoria FROM Tb_Professor WHERE Email_Professor='" + txtEmailLogin.Text + "' and Senha_Professor='" + txtSenhaLogin.Text + "' UNION ALL SELECT Id_Aluno, Nome_Aluno, Email_Aluno,Senha_Aluno, Categoria FROM Tb_Aluno WHERE Email_Aluno='" + txtEmailLogin.Text + "' and Senha_Aluno='" + txtSenhaLogin.Text + "'";
