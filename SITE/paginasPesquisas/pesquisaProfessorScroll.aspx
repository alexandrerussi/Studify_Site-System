<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pesquisaProfessorScroll.aspx.cs" Inherits="pesquisaProfessor" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StudifyConnectionString3 %>" SelectCommand="SELECT * FROM [Tb_Professor] WHERE (([Segmento_Professor] LIKE '%' + @Segmento_Professor + '%') AND ([Disciplina_Professor] LIKE '%' + @Disciplina_Professor + '%'))">
                <SelectParameters>
                    <asp:FormParameter FormField="DropDownList3" Name="Segmento_Professor" Type="String" />
                    <asp:FormParameter FormField="DropDownList4" Name="Disciplina_Professor" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
