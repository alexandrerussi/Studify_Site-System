<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pesquisaProfessorGraduacao.aspx.cs" Inherits="pesquisaProfessorGraduacao" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StudifyConnectionString3 %>" SelectCommand="SELECT * FROM [Tb_Professor] WHERE ([Segmento_Professor] LIKE '%' + @Segmento_Professor + '%')">
                <SelectParameters>
                    <asp:FormParameter FormField="txtGraduacao" Name="Segmento_Professor" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
