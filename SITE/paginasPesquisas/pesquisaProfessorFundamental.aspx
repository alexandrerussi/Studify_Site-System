<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pesquisaProfessorFundamental.aspx.cs" Inherits="pesquisaProfessorFundamental" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StudifyConnectionString3 %>" SelectCommand="SELECT * FROM [Tb_Professor] WHERE ([Segmento_Professor] LIKE '%' + @Segmento_Professor + '%')">
                <SelectParameters>
                    <asp:FormParameter FormField="txtEnsinoFundamental" Name="Segmento_Professor" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
