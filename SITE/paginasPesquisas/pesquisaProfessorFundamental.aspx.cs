...
public partial class pesquisaProfessorFundamental : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //AQUI ISRAEL, TEM UM PROBLEMA AQUI TAMBÉM NA QUESTÃO DE CONTAGENS, NÃO SEI COMO FAÇO PARA ELE SABER QUE SÓ QUERO PESQUISAR EM RELAÇÃO A UMA COISA SÓ. NO CASO PESQUISAR SOMENTE O SEGMENTO A PARTIR DO CLICK DO USUARIO NO MENU
        string busca3 = Request.Form["txtEnsinoFundamental"];
        con.Open();
        string strsqltotal = "select count(*) from tb_professor where segmento_professor like'%" + busca3 + "%'";
