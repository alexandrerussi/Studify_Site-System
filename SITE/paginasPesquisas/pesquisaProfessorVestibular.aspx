<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pesquisaProfessorVestibular.aspx.cs" Inherits="pesquisaProfessorVestibular" %>
...
<body style="background-color: #f5f5f5;">
    <form id="form1" runat="server">
        <div>
                    ...
                    <div class="col s8 hide-on-med-and-down">
                        <ul>
                            <li class="fontColoredMenu">
                                <a href="pesquisaProfessorFundamental.aspx">
                            ...
                            <li class="fontColoredMenu">
                                <a href="pesquisaProfessorMedio.aspx">
                            ...
                            <li class="fontColoredMenu">
                                <a href="pesquisaProfessorVestibular.aspx">
                            ...
                            <li class="fontColoredMenu">
                                <a href="pesquisaProfessorTecnico.aspx">
                            ...
                            <li class="fontColoredMenu">
                                <a href="pesquisaProfessorGraduacao.aspx">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StudifyConnectionString3 %>" SelectCommand="SELECT * FROM [Tb_Professor] WHERE ([Segmento_Professor] LIKE '%' + @Segmento_Professor + '%')">
                <SelectParameters>
                    <asp:FormParameter FormField="txtPreVestibular" Name="Segmento_Professor" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
