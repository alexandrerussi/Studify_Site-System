...
<head runat="server">
    <title>Cadastro Aluno - Studify</title>
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            $("#txtCpfCadastroResponsavel").mask("999.999.999-99");
...
<body class="grey lighten-4">
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StudifyConnectionString3 %>" SelectCommand="SELECT * FROM [Tb_Aluno]"></asp:SqlDataSource>
        <div>
            ...
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                <asp:View ID="cadastroAlunoParte1" runat="server">
                    <div class="col s12 container card-panel-cadastro">
                        <h2 class="titulo center-align black-text">Cadastre-se como aluno!</h2>
                        <h5 class="fonteFina center-align black-text subtituloModal2">comece a evoluir em alguns cliques!</h5>
                        <%--<div>
                            <asp:Button ID="btnPreencherProf1" runat="server" Text="Button" CssClass="center borderNone white-text white btnProximoPasso2 btnCadastroAluno" CausesValidation="False" OnClick="btnPreencherProf1_Click" /></div>--%>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col l6 m6 s12 paddingEditCadastro">
                ...
                <asp:View ID="cadastroAlunoParte2" runat="server">
                    <div class="col s12 container card-panel-cadastro">
                        <h2 class="titulo center-align black-text">Cadastre-se como aluno!</h2>
                        <h5 class="fonteFina center-align black-text subtituloModal2">Dados do responsável!</h5>
                        <div class="row">
                            <div class="input-field col l6 m12 s12 paddingEditCadastro">
            ...
            <div id="modal5" class="modal modal-cadastro">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="btnCadastroAluno" runat="server" Text="FINALIZAR" CssClass="right btn teal waves-effect waves-light marginTopBtnFinalizar2 btnInfoSocial" OnClick="btnCadastroAluno_Click" />
            ...
            <div id="modal1" class="modal modalLogin">
                <div class="modal-content">
                    ...
                    <div class="row left-align">
                        <div class="input-field col s12">
                            <asp:TextBox ID="TextBox1" CssClass="validate" runat="server" TextMode="Email"></asp:TextBox>
                            <label for="txtEmail">Email</label>
                        </div>
                    </div>
