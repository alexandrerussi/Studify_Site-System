...
<head runat="server">
    <title>Esqueci minha senha - Studify</title>
...
<body class="grey lighten-4">
    <form id="form1" runat="server">
        ...
        <div class="geral">
            ...
            <div class="contentEsqueci">
                <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                    <asp:View ID="esqueciSenha1" runat="server">
                        <div class="col s12 container card-panel-cadastro">
                            <h2 class="titulo center-align black-text">Esqueci minha senha</h2>
                            <h5 class="fonteFina center-align black-text subtituloModal2">Insira seu email, para lhe enviarmos um código de confirmação!</h5>

                            <div class="row">
                                <div class="input-field col offset-l2 l6 m12 s12 ">
                                    <asp:TextBox ID="txtEmailEsqueci" CssClass="validate" TextMode="Email" runat="server"></asp:TextBox>
                                    <label for="txtEmailEsqueci">Email</label>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" CssClass="red-text" ErrorMessage="Campo obrigatório" ControlToValidate="txtEmailEsqueci"></asp:RequiredFieldValidator>
                                </div>

                                <div class="col l3 m12 s12 center-align">
                                    <asp:Button ID="btnEsqueci1" runat="server" Text="PRÓXIMO PASSO" CssClass="btn teal waves-effect waves-light btnEsqueci" OnClick="btnEsqueci1_Click" />
                                </div>
                            </div>
                        </div>
                    </asp:View>

                    <asp:View ID="esqueciSenha2" runat="server">
                        <div class="col s12 container card-panel-cadastro">
                            <h2 class="titulo center-align black-text">Esqueci minha senha</h2>
                            <h5 class="fonteFina center-align black-text subtituloModal2">Digite seu  código de confirmação!</h5>

                            <div class="row">
                                <div class="input-field col offset-l2 l6 m12 s12 ">
                                    <asp:TextBox ID="txtIdEsqueci" CssClass="validate" runat="server"></asp:TextBox>
                                    <label for="txtIdEsqueci">Código de confirmação</label>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="red-text" ErrorMessage="Campo obrigatório" ControlToValidate="txtIdEsqueci"></asp:RequiredFieldValidator>
                                </div>

                                <div class="col l3 m12 s12 center-align">
                                    <asp:Button ID="btnEsqueci2" runat="server" Text="PRÓXIMO PASSO" CssClass="btn teal waves-effect waves-light btnEsqueci" OnClick="btnEsqueci2_Click" />
                                </div>
                            </div>
                        </div>
                    </asp:View>

                    <asp:View ID="esqueciSenha3" runat="server">
                        <div class="col s12 container card-panel-cadastro">
                            <h2 class="titulo center-align black-text">Esqueci minha senha</h2>
                            <h5 class="fonteFina center-align black-text subtituloModal2">Insira sua nova senha!</h5>
                            <div class="row">
                                <div class="input-field col l6 m12 s12 paddingEditCadastro">
                                    <asp:TextBox ID="txtSenhaEsqueci" CssClass="validate" TextMode="password" runat="server"></asp:TextBox>
                                    <label for="txtSenhaEsqueci">Senha</label>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" CssClass="red-text" ErrorMessage="Campo obrigatório" ControlToValidate="txtSenhaEsqueci"></asp:RequiredFieldValidator>
                                </div>
                                <div class="input-field col l6 m12 s12 paddingEditCadastro">
                                    <asp:TextBox ID="txtConfirmarSenhaEsqueci" CssClass="validate" TextMode="password" runat="server"></asp:TextBox>
                                    <label for="txtConfirmarSenhaEsqueci">Confirmar Senha</label>
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" CssClass="red-text" ErrorMessage="Campos diferentes" ControlToValidate="txtConfirmarSenhaEsqueci" ControlToCompare="txtSenhaEsqueci"></asp:CompareValidator>
                                </div>

                            </div>
                            <div class="row">
                                <div class="col l12 m12 s12 center-align">
                                    <asp:Button ID="btnEsqueci3" runat="server" Text="ALTERAR SENHA" CssClass="btn teal waves-effect waves-light btnEsqueci" OnClick="btnEsqueci3_Click" />
                                </div>
                            </div>
                        </div>
                    </asp:View>
